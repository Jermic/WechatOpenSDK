#
#  Be sure to run `pod spec lint WechatOpenSDKJD.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Jermic"
  # spec.authors            = { "Jermic" => "jermic@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Jermic"
